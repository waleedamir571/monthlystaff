        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="inter">Connect directly with top-tier Pakistani developers with exceptional skills, honest pricing, and real and unfiltered reviews.
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="developer-card inter">
                    <p>$500 pm | 4 yrs</p>
                    <img src="./img/circle.png" alt="Ahmed K.">
                    <h5 class="">Ahmed K.</h5>
                    <p>PHP Developer</p>
                    <p>Lahore</p>
                    <div class="rating">
                    ...
                    <a href="https://wa.me/0000000000" class="whatsapp-btn"><img class="w-30" src="./img/WhatsApp.png" alt=""> WhatsApp Me</a>
                </div>
            </div>
            <div class="col-md-3">
                <div class="developer-card inter">
                    <p>$500 pm | 4 yrs</p>
                    <img src="./img/1.png" alt="Ahmed K.">
                    <h5 class="">Ahmed K.</h5>
                    <p>PHP Developer</p>
                    <p>Lahore</p>
                    <div class="rating">
