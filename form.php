        ...
        <div class="login-container">
            ...
            <div class="form-container">
                ...
                <form>
                    ...
                    <input type="number" placeholder="number" id="password">

                    <label for="">Stack</label>
                    <input type="text" placeholder="Stack" id="password">

                    <label for="">City</label>
                    <input type="text" placeholder="Stack" id="password">

                    <label for="">Country</label>
                    <input type="text" placeholder="Country" id="password">

                    <label for="">Salary</label>
                    <input type="text" placeholder="Salary" id="password">
